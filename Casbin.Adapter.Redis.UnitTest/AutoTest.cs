...
namespace Casbin.Adapter.Redis.UnitTest
{
    ...
    public class AdapterTest : TestUtil, IClassFixture<ModelProvideFixture>
    {
        ...
        private static readonly RedisKey Key = "casbin_rules";
        ...
        public void TestAdapterAutoSave()
        {
            ...
            Assert.True(Array2DEquals(adapter.GetPoliciesInDb(), AsList(
                AsList("alice", "data1", "read"),
                AsList("bob", "data2", "write"),
                AsList("data2_admin", "data2", "read"),
                AsList("data2_admin", "data2", "write"),
        ...
        private static void InitPolicy()
        {
            ...
            db.KeyDelete(Key);
            db.SortedSetAdd(Key, JsonConvert.SerializeObject(new CasbinRule
            {
                PType = "p",
                V0 = "alice",
                V1 = "data1",
